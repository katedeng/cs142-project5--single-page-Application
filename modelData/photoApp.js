...
(function() {
    ...
    var comment3 = {
        ...
        comment: 'If you see this text in <b>boldface</b>, then HTML escaping is not working properly',
        user: jo,
        photo_id: photo1._id
    };
    ...
    var comment4 = {
        ...
        comment: 'If there is one thing the history of evolution has ' +
            'taught us it is that life will not be contained. Life breaks ' +
